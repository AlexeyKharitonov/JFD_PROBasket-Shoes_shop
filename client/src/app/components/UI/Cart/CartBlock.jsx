    ...
    <div className="relative flex items-center lg:text-base md:text-sm sm:text-xs">
      <div className="relative lg:text-base md:text-sm sm:text-xs ">
        <span onClick={openModal}>
          <IoMdCart className="w-8 h-8 hover:scale-102 sm:w-9 sm:h-9 md:w-9 md:h-9 lg:w-11 lg:h-11 text-[#FCCA3D] hover:text-yellow-600 " />
        </span>
        <CounterInCart count={items.length} />
      </div>
      <div className="flex flex-col text-gray-300 items-end ml-1.5 sm:inline-block">
